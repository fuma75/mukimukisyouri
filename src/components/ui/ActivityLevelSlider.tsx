...
const SittingSvg = () => (
  <svg viewBox="0 0 100 100" width="110" height="110">
    ...
    {/* Laptop */}
    <rect x="45" y="55" width="22" height="5" fill="#1a73e8" rx="2" />
    <polygon points="62,55 75,30 80,30 67,55" fill="#1a73e8" />
    {/* Chair */}
    <rect x="15" y="60" width="30" height="5" fill="#1a73e8" rx="2" />
    <rect x="25" y="65" width="5" height="25" fill="#1a73e8" rx="2" />
    <rect x="10" y="25" width="5" height="40" fill="#1a73e8" rx="2" />
    
    {/* Person Head */}
    <circle cx="38" cy="20" r="10" fill="#1a73e8" />
    {/* Person Body */}
    <path d="M30 35 Q40 25 45 35 L45 55 L25 55 L25 40 Z" fill="#1a73e8" />
    {/* Leg */}
    <path d="M35 50 L55 50 L55 75" stroke="#1a73e8" strokeWidth="8" strokeLinecap="round" fill="none" strokeLinejoin="round" />
    
    {/* Arm */}
    <g>
      <animateTransform attributeName="transform" type="translate" values="0 0; 0 2; 0 0" dur="0.5s" repeatCount="indefinite" />
      <path d="M38 40 L50 50 L60 50" stroke="#1a73e8" strokeWidth="6" strokeLinecap="round" fill="none" strokeLinejoin="round">
  ...
  <svg viewBox="0 0 100 100" width="110" height="110">
    <g transform="translate(100, 0) scale(-1, 1)">
      <g>
        ...
        {/* Back arm */}
        <path stroke="#1a73e8" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.4">
        ...
        {/* Back leg */}
        <path stroke="#1a73e8" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.4">
        ...
        {/* Head & Body */}
        <circle cx="50" cy="20" r="10" fill="#1a73e8" />
        <path d="M43 35 Q50 25 57 35 L52 60 L48 60 Z" fill="#1a73e8" />
        
        {/* Front arm */}
        <path stroke="#1a73e8" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none">
        ...
        {/* Front leg */}
        <path stroke="#1a73e8" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" fill="none">
...
const JumpingSvg = () => (
  <svg viewBox="0 0 100 100" width="110" height="110">
    <g>
      ...
      {/* Head & Body */}
      <circle cx="50" cy="20" r="10" fill="#1a73e8" />
      <path d="M43 35 Q50 25 57 35 L55 60 L45 60 Z" fill="#1a73e8" />
      
      {/* Left arm */}
      <path stroke="#1a73e8" strokeWidth="7" strokeLinecap="round" fill="none" strokeLinejoin="round">
      ...
      {/* Left leg */}
      <path d="M48 60 L40 85" stroke="#1a73e8" strokeWidth="8" strokeLinecap="round">
        <animateTransform attributeName="transform" type="rotate" values="0 48 60; 30 48 60; 0 48 60" dur="1s" repeatCount="indefinite" />
      </path>
      
      {/* Right leg */}
      <path d="M52 60 L60 85" stroke="#1a73e8" strokeWidth="8" strokeLinecap="round">
